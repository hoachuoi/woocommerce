...
<?php if( $wishlist_enable && $show_wishlist && $enable_header_wishlist_icon ) : 
    ...
    <a class="header-item header-wishlist-icon" href="<?php echo esc_url( get_permalink( get_option('emoza_wishlist_page_id') ) ); ?>" title="<?php echo esc_attr__( 'Your wishlist', 'emoza-woocommerce' ); ?>">
