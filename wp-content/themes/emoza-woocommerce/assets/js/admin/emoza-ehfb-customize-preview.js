...
(function ($) {
  ...
  wp.customize.bind('preview-ready', function () {
    $(document).on('click', '.ehfb-item-customizer-focus', function (e) {
      e.preventDefault();
      e.stopPropagation();
      ...
      var id = $(this).closest('.ehfb-builder-item').data('component-id');

      // Check builder type.
      var currentBuilderSelector = '.emoza-ehfb-header';
      if ($(this).closest('.ehfb-footer').length) {
        currentBuilderSelector = '.emoza-ehfb-footer';
      }

      // Go to component section.
      if ($(this).closest('.ehfb-header').length || $(this).closest('.ehfb-mobile_offcanvas').length) {
    ...
    $('html').on('mouseup', function () {
      $(window.parent.document).find('#emoza-ehfb-elements').removeClass('show');
    });
   ...
   */
  function ehfb_hide_empty_rows() {
    $('.ehfb-row').each(function () {
      if ($(this).hasClass('ehfb-is-row-empty')) {
        $(this).parent().parent().addClass('em-d-none');
      } else {
        $(this).parent().parent().removeClass('em-d-none');
      }
    });
  }
  ...
  var css = {
    ...
    'ehfb_contact_info_display_inline': {
      'selector': '.ehfb-component-contact_info .header-contact',
            ...
            try {
              for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
                ...
                var optionID = 'emoza_' + builder + '_row__' + row + '_' + builder + '_row_column' + i + '_' + opt,
                  columnSelector = '.ehfb-' + builder + ' .ehfb-' + row + '_' + builder + '_row .ehfb-column-' + i;
                if (opt.indexOf('elements_spacing') !== -1) {
                  columnSelector += ' .ehfb-builder-item + .ehfb-builder-item';
                }
                resp_css[optionID] = {
