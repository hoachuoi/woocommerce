...
foreach( $this->header_rows as $row ) {
    ...
    // Up to 6 columns.
    for( $i=1; $i<=6; $i++ ) {
        $section_id = 'emoza_header_row__' . $row['id'] . '_column' . $i;
        ...
        // Vertical Alignment.
        $default = Emoza_Header_Footer_Builder::get_row_column_default_customizer_value( $row[ 'id' ], $i, 'vertical_alignment' );
        ...
        $default = Emoza_Header_Footer_Builder::get_row_column_default_customizer_value( $row[ 'id' ], $i, 'inner_layout' );
        ...
        $default = Emoza_Header_Footer_Builder::get_row_column_default_customizer_value( $row[ 'id' ], $i, 'horizontal_alignment' );
