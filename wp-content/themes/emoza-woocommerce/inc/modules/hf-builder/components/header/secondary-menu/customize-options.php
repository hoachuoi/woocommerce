...
$wp_customize->add_section(
    new Emoza_Section_Hidden(
        $wp_customize,
        'emoza_section_hb_component__secondary_menu',
        array(
            'title'      => esc_html__( 'Secondary Menu', 'emoza-woocommerce' ),
...
$wp_customize->add_setting(
    'emoza_section_hb_component__secondary_menu_tabs',
    array(
        'default'           => '',
...
$wp_customize->add_control(
    new Emoza_Tab_Control (
        ...
        array(
            'label' 				=> '',
            'section'       		=> 'emoza_section_hb_component__secondary_menu',
...
foreach( $opts_to_move as $control_tabs ) {
    foreach( $control_tabs as $option_name ) {
        ...
        if( 'topbar_nav_link' === $option_name ) {
            $wp_customize->get_control( $option_name )->label = esc_html__( 'Secondary Menu', 'emoza-woocommerce' );   
            $wp_customize->get_control( $option_name )->rm_desc_mt = true;    
        }
		
        $wp_customize->get_control( $option_name )->section  = 'emoza_section_hb_component__secondary_menu';
