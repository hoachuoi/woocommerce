<div class="emoza-dashboard-card emoza-dashboard-card-no-box-shadow">
    <div class="emoza-dashboard-card-inner-header em-mb-10px">
        <h2 class="em-font-size-20px em-mb-10px em-mt-0"><?php echo esc_html__( 'Customization Settings', 'emoza-woocommerce' ); ?></h2>
        <p class="em-text-color-grey em-m-0">The customization settings for the shop filters.</p>
    </div>
    <div class="em-shop-filter-settings">
    ...
    <a href="<?php echo esc_url( $this->settings['pf_upgrade_pro'] ); ?>" class="button button-primary emsf-save-settings emoza-dashboard-pro-tooltip" data-tooltip-message="<?php echo esc_attr__( 'This is only available on Emoza Pro', 'emoza-woocommerce' ); ?>" target="_blank" style="max-width: 150px;">
        Save settings
