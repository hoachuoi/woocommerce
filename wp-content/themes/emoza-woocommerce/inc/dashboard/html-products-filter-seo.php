<div class="emoza-dashboard-card emoza-dashboard-card-no-box-shadow">
    <div class="emoza-dashboard-card-inner-header em-mb-10px">
        <h2 class="em-font-size-20px em-mb-10px em-mt-0"><?php echo esc_html__( 'SEO Settings', 'emoza-woocommerce' ); ?></h2>
        <p class="em-text-color-grey em-m-0">The SEO settings for the shop filters.</p>
    </div>
