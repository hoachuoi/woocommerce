...
<div class="emoza-dashboard-notifications-sidebar">
    <a href="#" class="emoza-dashboard-notifications-sidebar-close" title="<?php echo esc_attr__( 'Close the sidebar', 'emoza-woocommerce' ); ?>">
    ...
    <div class="emoza-dashboard-notifications-sidebar-inner">

        <div class="emoza-dashboard-notifications-sidebar-header">
            <div class="emoza-dashboard-notifications-sidebar-header-icon">
            ...
            <div class="emoza-dashboard-notifications-sidebar-header-content">
                <h3>
                    <?php 
                    if( $notification_read ) {
                        echo esc_html__( 'Latest News', 'emoza-woocommerce' );
                    } else {
                        echo esc_html__( 'New Update', 'emoza-woocommerce' );
                    } ?>
                </h3>
                <p><?php echo esc_html__( 'Check the latest news from Emoza', 'emoza-woocommerce' ); ?></p>
            </div>
        </div>
        <?php if( $this->settings[ 'notifications_tabs' ] ) : ?>
            <div class="emoza-dashboard-notifications-sidebar-tabs">
                <nav class="emoza-dashboard-tabs-nav emoza-dashboard-tabs-nav-no-negative-margin" data-tab-wrapper-id="notifications-sidebar">
                    <ul>
                        <li class="emoza-dashboard-tabs-nav-item active">
                            <a href="#" class="emoza-dashboard-tabs-nav-link" data-tab-to="notifications-sidebar-emoza">
                                <?php echo esc_html__( 'Emoza', 'emoza-woocommerce' ); ?>
                            </a>
                        </li>
                        <li class="emoza-dashboard-tabs-nav-item">
                            <a href="#" class="emoza-dashboard-tabs-nav-link" data-tab-to="notifications-sidebar-emoza-pro">
                                <?php echo esc_html__( 'Emoza Pro', 'emoza-woocommerce' ); ?>
                            </a>
                        </li>
                    </ul>
                </nav>
        ...
        <?php endif; ?>
        <div class="emoza-dashboard-notifications-sidebar-body emoza-dashboard-tab-content-wrapper" data-tab-wrapper-id="notifications-sidebar">
            <div class="emoza-dashboard-tab-content active" data-tab-content-id="notifications-sidebar-emoza">
                <?php 
                ...
                if( isset( $this->settings[ 'notifications' ] ) && $this->settings[ 'notifications' ] ) : 
                    ...
                    <?php foreach( $this->settings[ 'notifications' ] as $notification ) : 
                        ...
                        <div class="emoza-dashboard-notification">
                            <?php if( $date ) : ?>
                                <span class="emoza-dashboard-notification-date" data-raw-date="<?php echo esc_attr( $date ); ?>">
                                    <?php echo esc_html( date_format( date_create( $date ), 'F j, Y' ) ); ?>
                                    <?php if( $display_version ) : ?>
                                        <span class="emoza-dashboard-notification-version"><?php echo sprintf( '(%s)', $version ); ?></span>
                                    <?php endif; ?>
                                </span>
                            <?php endif; ?>
                            <?php if( $content ) : ?>
                                <div class="emoza-dashboard-notification-content">
                ...
                <?php else : ?>
                    ...
                    <div class="emoza-dashboard-notification">
                        <div class="emoza-dashboard-notification-content">
                            <p class="changelog-description"><?php echo esc_html__( 'No notifications found', 'emoza-woocommerce' ); ?></p>
                        </div>
                    </div>
            ...
            <?php if( $this->settings[ 'notifications_tabs' ] ) : ?>
            <div class="emoza-dashboard-tab-content" data-tab-content-id="notifications-sidebar-emoza-pro">
                <?php 
                ...
                if( isset( $this->settings[ 'notifications_pro' ] ) && $this->settings[ 'notifications_pro' ] ) : 
                    ...
                    <?php foreach( $this->settings[ 'notifications_pro' ] as $notification ) : 
                        ...
                        <div class="emoza-dashboard-notification">
                            <?php if( $date ) : ?>
                                <span class="emoza-dashboard-notification-date">
                                    <?php echo esc_html( date_format( date_create( $date ), 'F j, Y' ) ); ?>
                                    <?php if( $display_version ) : ?>
                                        <span class="emoza-dashboard-notification-version"><?php echo sprintf( '(%s)', $version ); ?></span>
                                    <?php endif; ?>
