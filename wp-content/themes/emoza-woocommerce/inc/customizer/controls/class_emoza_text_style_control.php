...
class Emoza_Text_Style_Control extends WP_Customize_Control {
		
	/**
	 * The type of control being rendered
	 */
	public $type = 'emoza-text-style-control';
	...
	?>
		<div class="emoza-text-style">
			<div class="emoza-text-style-wrap">
				<span class="emoza-text-style-title"><?php echo esc_html__( 'Decoration', 'emoza-woocommerce' ); ?></span>
				<div class="emoza-text-style-label">
					<label>
			...
			<div class="emoza-text-style-wrap">
				<span class="emoza-text-style-title"><?php echo esc_html__( 'Letter Case', 'emoza-woocommerce' ); ?></span>
				<div class="emoza-text-style-label">
					<label>
